...
<div class="max-w-3xl fade-in">
    ...
    <div class="card p-6 mb-6 relative overflow-hidden group hover:shadow-lg transition-all duration-300">
        <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-indigo-500/10 to-cyan-500/10 rounded-full blur-3xl group-hover:scale-110 transition-transform duration-500"></div>
        <div class="relative flex items-center justify-between">
            <div>
                <div class="flex items-center gap-2 mb-2">
                    <div class="w-2 h-2 rounded-full" style="background: linear-gradient(135deg, #6366F1, #22D3EE);"></div>
    ...
    <div class="rounded-xl p-6 mb-6 relative overflow-hidden group hover:shadow-lg transition-all duration-300"
        ...
        <div class="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-indigo-500/5 to-cyan-500/5 rounded-full blur-3xl"></div>
        <div class="relative flex items-start gap-4">
            ...
            <div>
                <p class="font-bold text-base mb-2 bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent">Quiz Instructions</p>
                <p class="text-sm leading-relaxed" style="color: #94A3B8;">Answer all questions honestly. You need <strong class="text-indigo-400">60% or higher</strong> to pass. These questions test whether you understood the project — not just whether AI wrote it for you.</p>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('quiz.submit', $project) }}" id="quiz-form">
        ...
        <div class="space-y-5">
            ...
            <div class="card p-6 relative overflow-hidden group hover:shadow-lg transition-all duration-300">
                <div class="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-indigo-500/5 to-cyan-500/5 rounded-full blur-2xl"></div>
                <div class="relative">
                    ...
                    <div class="space-y-2 ml-14">
                        ...
                        <label class="flex items-center gap-3 p-4 rounded-xl cursor-pointer transition-all duration-200 quiz-option group/option relative overflow-hidden"
                            ...
                            <div class="relative">
                                <input type="radio" name="answers[{{ $question->id }}]" value="{{ $opt }}"
                                    class="w-4 h-4 accent-indigo-500 opacity-0 absolute"
        ...
        <div class="mt-8 p-6 rounded-xl relative overflow-hidden"
            ...
            <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-indigo-500/10 to-cyan-500/10 rounded-full blur-3xl"></div>
            <div class="relative flex items-center justify-between">
